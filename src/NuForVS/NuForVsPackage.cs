...
namespace NuForVS
{
    ...
    [Guid(GuidList.guidNuForVSPkgString)]
    public sealed class NuForVsPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidNuForVSCmdSet, (int)PkgCmdIDList.cmdidAddNuReference);
